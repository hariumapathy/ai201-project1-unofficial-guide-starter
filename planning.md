...
| 3 | Do I need to know multiple programming languages to succeed in CS220, due to the course's name? | Although knowing multiple programming languages might help you feel more confident, the course is taught in JavaScript, so multiple languages are not strictly required. However, the general principles you learn in the course can be applied to a variety of programming languages. |
